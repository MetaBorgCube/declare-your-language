...
4. Import the initial Spoofax projects into your workspace:
    ...
    3. Choose **Maven**
    3. Choose **Existing Maven Projects** from the list.
    4. Select the **paplj` directory.
...
* Open the 1-2-numbers.spt test-suite in the exercises projects

* Add productions to make the exercise tests succeed
  * syntax/Expressions.sdf3 

* Use the doodle.pj file to try out different programs, or browse in the paplj.examples project, or make your own

* Try out the `Spoofax/Syntax` menu entries:
  * Format
