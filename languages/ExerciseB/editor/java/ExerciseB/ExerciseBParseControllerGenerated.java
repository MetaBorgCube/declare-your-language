...
public class ExerciseBParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ExerciseB");
  ...
  { 
    ExerciseBParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ExerciseBParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ExerciseBParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ExerciseBParseControllerGenerated.class);
    }
  ...
  { 
    return ExerciseBParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
