...
public class PAPLJParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("PAPLJ");
  ...
  { 
    PAPLJParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = PAPLJParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = PAPLJParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(PAPLJParseControllerGenerated.class);
    }
  ...
  { 
    return PAPLJParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
