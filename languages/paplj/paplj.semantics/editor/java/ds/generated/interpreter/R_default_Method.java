...
public class R_default_Method  implements IConvertibleToStrategoTerm
{ 
  public final A_Method value;

  public com.github.krukow.clj_ds.PersistentMap<Integer, A_V> _1;

  public R_default_Method (A_Method value, com.github.krukow.clj_ds.PersistentMap<Integer, A_V> _1) 
  { 
    this.value = value;
    this._1 = _1;
  }
