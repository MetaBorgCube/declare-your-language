...
public class LangBParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LangB");
  ...
  { 
    LangBParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LangBParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LangBParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LangBParseControllerGenerated.class);
    }
  ...
  { 
    return LangBParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
