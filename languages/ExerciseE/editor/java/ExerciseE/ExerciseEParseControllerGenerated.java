...
public class ExerciseEParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ExerciseE");
  ...
  { 
    ExerciseEParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ExerciseEParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ExerciseEParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ExerciseEParseControllerGenerated.class);
    }
  ...
  { 
    return ExerciseEParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
