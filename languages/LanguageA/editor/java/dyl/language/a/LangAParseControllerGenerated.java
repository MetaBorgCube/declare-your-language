...
public class LangAParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LangA");
  ...
  { 
    LangAParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LangAParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LangAParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LangAParseControllerGenerated.class);
    }
  ...
  { 
    return LangAParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
