...
public class ExerciseCParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ExerciseC");
  ...
  { 
    ExerciseCParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ExerciseCParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
  ...
  { 
    return ExerciseCParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
