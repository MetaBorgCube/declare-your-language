...
public class ExerciseDParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ExerciseD");
  ...
  { 
    ExerciseDParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ExerciseDParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ExerciseDParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ExerciseDParseControllerGenerated.class);
    }
  ...
  { 
    return ExerciseDParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
