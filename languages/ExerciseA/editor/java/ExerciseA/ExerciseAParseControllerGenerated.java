...
public class ExerciseAParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ExerciseA");
  ...
  { 
    ExerciseAParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ExerciseAParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ExerciseAParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ExerciseAParseControllerGenerated.class);
    }
  ...
  { 
    return ExerciseAParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
