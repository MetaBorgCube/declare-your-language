...
public class LangEParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LangE");
  ...
  { 
    LangEParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LangEParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LangEParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LangEParseControllerGenerated.class);
    }
  ...
  { 
    return LangEParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
