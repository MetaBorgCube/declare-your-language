...
public class LangCParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LangC");
  ...
  { 
    LangCParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LangCParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LangCParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LangCParseControllerGenerated.class);
    }
  ...
  { 
    return LangCParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
