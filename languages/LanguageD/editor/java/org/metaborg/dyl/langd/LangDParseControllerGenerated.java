...
public class LangDParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("LangD");
  ...
  { 
    LangDParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = LangDParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = LangDParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(LangDParseControllerGenerated.class);
    }
  ...
  { 
    return LangDParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
